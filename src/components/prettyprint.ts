...
const printObject = (object: any, out: PrintWriter, idt: number, selection: object | null, options: Options): void => {
...
const prettyPrint = (object: object, selection?: any, options?: Options): string => {
